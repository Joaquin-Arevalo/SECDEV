...
const man_empman_payroll_controller = {
    get_man_empman_payroll: function(req, res){
        res.render("manager-empman-payroll", { LCF: req.session.LCF});
    },
    ...
    get_emp_total: async function(req, res){
        try{
            ...
            res.render("manager-empman-payroll", {emp_total, LCF: req.session.LCF});
        }catch(error){
    ...
    get_emp_wpay: async function(req, res){
        ...
        try{
            ...
            res.render("manager-empman-payroll", {emp_wpay, emp_total, Total_Hour_Rate, Total_Minute_Rate, LCF: req.session.LCF});
        }catch(error){
